...
I could not figure out how to do this in 1 line of code
...
mv luke_skywalker.txt rebellion/millenium_falcon
mv obi_wan.txt rebellion/millenium_falcon
mv princess_leia.txt rebellion/millenium_falcon
